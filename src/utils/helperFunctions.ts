...
export const getQueryParams = <T>(paramsFromRequest: paramsFromRequest, missingParamsErrorMessage: string, ...queryParams: string[]): T => {
  let result = {} as any;
...
export const getHeaders = <T>(headersFromEvent: HeadersType, missingHeaderErrorMessage: string, ...headers: string[]): T => {
  let result = {} as any;
...
export const getAttributeFromUpdatedData = <T>(allAttributes: any, missingAttributeErrorMessage: string, ...attributes: string[]) => {
  let result = {} as any;
