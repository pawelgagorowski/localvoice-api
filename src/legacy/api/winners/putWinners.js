...
exports.handler = async (event) => {
  try {
    ...
    const listOfCoursesWithParticipants = await CourseParticipants.getCourseParticipantsBasedOnListFromPreviousMonth(listOfCoursesWithCorespondingBusinesses, env);
